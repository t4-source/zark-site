  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      <div className="grid lg:grid-cols-2 gap-12">
        <div>
          <h1 className="text-3xl font-bold text-slate-900 mb-8">Security Operations Services</h1>
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-semibold text-slate-900">24/7 Security Monitoring</h2>
              </div>
            ...
            <div className="bg-slate-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-semibold text-slate-900">Incident Response</h2>
              </div>
              <ul className="space-y-2 text-slate-700">
            ...
            <div className="bg-slate-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-semibold text-slate-900">Threat Intelligence</h2>
              </div>
              <ul className="space-y-2 text-slate-700">
                <li>• Threat landscape analysis</li>
                <li>• IOCs and threat feeds</li>
        ...
        <div>
          ...
          <div className="mb-8 flex justify-center">
            <Image
              src="/operations.gif"
              alt="Security Operations Services"
              width={250}
              height={150}
          ...
          <div className="bg-gradient-to-br from-orange-50 to-red-100 rounded-lg p-8 mb-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-slate-800 mb-2">Security Operations</h3>
              <p className="text-slate-600 text-sm">24/7 monitoring and incident response</p>
            </div>
          </div>

          <div className="bg-slate-100 rounded-lg p-8 mb-8">
            <h3 className="text-xl font-semibold text-slate-900 mb-4">Our Security Operations Capabilities</h3>
            <ul className="space-y-3 text-slate-700">
              <li className="flex items-start">
                ...
                <span>Advanced SIEM and SOAR platforms</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span>Certified security analysts</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-600 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="bg-white border border-slate-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Request Security Operations Assessment</h3>
            <form action="/api/contact" method="post" className="space-y-4">
              ...
              <div>
                ...
                <textarea id="message" name="message" rows={4} required className="w-full px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Tell us about your security operations requirements..."></textarea>
              </div>
