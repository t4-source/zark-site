      ...
      <div className="relative z-10 max-w-2xl mx-4 w-full rounded-lg bg-white shadow-xl border border-slate-200">
        <div className="p-6">
          ...
          <div className="text-sm text-slate-700 space-y-3">
            <p>
              The rules of Institute of Chartered Accountants of India prohibit Chartered Accountants firm from advertising and soliciting work in the public domain. This website is solely meant for the purpose of information and not for the purpose of advertising. Z A R K & Co LLP does not intend to solicit clients through this website. We do not take the responsibility of any action taken by any person based on the information posted here.
            </p>
            <p>
